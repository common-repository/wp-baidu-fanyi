...
$pd_title = 'WP百度翻译插件设置';
$pd_version = WP_BAIDU_FANYI_VERSION;
$pd_code = 'bfy-setting';
$pd_index_url = 'https://www.wbolt.com/plugins/bfy';
$pd_doc_url = 'https://www.wbolt.com/bfy-plugin-documentation.html';
            ...
            <div class="sc-body">
                ...
                <table class="wbs-form-table">
                    ...
                    <tr>
                        ...
                        <td><p class="description">请输入百度翻译的准入APP ID 及 密钥，访问<a class="link" target="_blank" href="http://api.fanyi.baidu.com/">百度翻译开放平台</a>获取，<a class="link" target="_blank" href="https://www.wbolt.com/how-to-get-baidu-tokenid.html">查看教程</a>。
                            </p></td>
                    </tr>
                    <tr>
                        <th class="row w8em">APP ID</th>
                        <td>
                            <input id="wb_bdsl_bdkey" class="wbs-input" data-max="80" name="<?php echo $setting_field;?>[appid]" type="text" value="<?php echo isset($op_sets['appid']) ?  $op_sets['appid'] : '' ;?>" placeholder="">
                    ...
                    <tr>
                        <th class="row w8em">密钥</th>
                        <td>
                            <input id="wb_bdsl_bdkey" class="wbs-input" data-max="80" name="<?php echo $setting_field;?>[appkey]" type="text" value="<?php echo isset($op_sets['appkey']) ?  $op_sets['appkey'] : '' ;?>" placeholder="">
                            </p>
